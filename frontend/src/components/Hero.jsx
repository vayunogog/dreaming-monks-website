  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="hidden md:block absolute -right-32 top-[22%] w-[30rem] h-[38rem] border-2 border-black/25"
      />
      <div aria-hidden="true" className="absolute left-0 bottom-0 w-2/3 h-px bg-black/10" />
      <div aria-hidden="true" className="hidden md:block absolute right-6 top-1/2 -translate-y-1/2 rotate-90 origin-right text-[10px] font-bold tracking-[0.5em] uppercase text-black/25 whitespace-nowrap">
      ...
      >
        ...
        >
          ...
          <span className="text-[11px] md:text-xs font-bold tracking-[0.35em] uppercase text-black/70">
        ...
        <h1
          ...
          className="font-display uppercase leading-[0.88] tracking-tight text-[clamp(3.6rem,11.5vw,10.5rem)] text-black"
        >
        ...
        <motion.p
          ...
          className="mt-8 max-w-xl text-base md:text-lg text-black/70 leading-relaxed"
        >
        ...
        >
          ...
          <button
            ...
            className="group inline-flex items-center gap-3 border-2 border-black text-black hover:bg-black hover:text-white font-bold text-sm tracking-[0.15em] uppercase px-8 py-[0.85rem] transition-colors duration-200"
          >
            View Inventory
          ...
          <a
            ...
            className="inline-flex items-center gap-2 text-black/60 hover:text-brand-red text-xs font-bold tracking-[0.2em] uppercase underline underline-offset-8 decoration-black/30 hover:decoration-brand-red transition-colors duration-200"
          >
      ...
      >
        <span className="text-[10px] font-bold tracking-[0.4em] uppercase text-black/40">Scroll</span>
        <motion.span
